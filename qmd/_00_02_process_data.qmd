...
```{r process-education-data-at-entry}
...
```{r process-employment-data-at-entry}
...
```{r process-health-data-at-entry}
...
```{r process-health-conditions-and-disabilities-data-at-entry}
data_health_conditions_and_disabilites_entry <- process_program_specific_data_element(
    data_element = dm$disabilities |> dplyr::distinct(),
    enrollments = entries_in_period,
    stage = "Project start"
) |>
