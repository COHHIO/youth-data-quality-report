...
```{r get-enrollments-in-period}
enrollments_in_period <- dm$enrollment |>
...
```{r process-enrollment-data}
data_enrollment <- dm$enrollment |>
    dplyr::semi_join(
        enrollments_in_period,
    ...
    dplyr::mutate(
        ...
        is_hoh = dplyr::case_when(
            ...
            factor(levels = c("Yes", "No", "Unknown")),
        is_hoh_or_adult = dplyr::case_when(
