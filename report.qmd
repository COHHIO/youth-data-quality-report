...
if (n_disabilities_records_at_entry_without_enrollment_record == 0) {
    cat("✅ All records collected at entry match an enrollment record.")
} else {
    cat(paste0("❌ ", n_disabilities_records_at_entry_without_enrollment_record, " records collected at entry don't match an enrollment record."))
}
```
...
if (n_enrollments_without_health_conditions_record == 0) {
    cat("✅ All enrollments have a health conditions and disabilities record.")
} else {
    cat(paste0("❌ ", n_enrollments_without_health_conditions_record, " enrollments are missing a health conditions and disabilities record."))
}
```
...
if (n_disabilities_records_at_exit_without_exit_record == 0) {
    cat("✅ All records collected at exit match an exit record.")
} else {
    cat(paste0("❌ ", n_disabilities_records_at_exit_without_exit_record, " records collected at exit don't match an exit record."))
}
...
if (n_exits_without_health_conditions_record == 0) {
    cat("✅ All exits have a health conditions and disabilities record.")
} else {
    cat(paste0("❌ ", n_exits_without_health_conditions_record, " exits are missing a health conditions and disabilities record."))
}
```
...
if (n_education_records_at_entry_without_enrollment_record == 0) {
    ...
    cat(paste0("❌ ", n_education_records_at_entry_without_enrollment_record, " records collected at entry don't match an enrollment record."))
}
```
...
if (n_enrollments_without_education_record == 0) {
    cat("✅ All enrollments have an education record.")
} else {
    cat(paste0("❌ ", n_enrollments_without_education_record, " enrollments are missing an education record."))
}
```
...
if (n_education_records_at_exit_without_exit_record == 0) {
    ...
    cat(paste0("❌ ", n_education_records_at_exit_without_exit_record, " records collected at exit don't match an exit record."))
}
...
if (n_exits_without_education_record == 0) {
    cat("✅ All exits have an education record.")
} else {
    cat(paste0("❌ ", n_exits_without_education_record, " exits are missing an education record."))
}
```
