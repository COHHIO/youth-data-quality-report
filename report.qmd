...
data_ethnicity |>
    ...
    gt::gt() |>
    gt::tab_header(title = "Client Self-Identified Race/Ethnicity Selections") |>
    gt::cols_label(
...
```{r check-last-grade-completed-responses}
data_education_entry |>
    create_data_quality_table(
        response_column = "last_grade_completed",
        group_column = "is_hoh_and_or_adult",
        group_column_label = "Head of Household and/or Adult",
        table_title = "Last Grade Completed"
    )
```

##### School Status

```{r check-school-status-responses}
data_education_entry |>
    create_data_quality_table(
        response_column = "school_status",
        group_column = "is_hoh_and_or_adult",
        group_column_label = "Head of Household and/or Adult",
        table_title = "School Status"
    )
```
